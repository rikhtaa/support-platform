(function () {
  "use strict"; const o = { WIDGET_URL: "https://support-platform-widget-lime.vercel.app/widget", DEFAULT_POSITION: "bottom-right" }, u = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="white" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <line x1="6" y1="6" x2="18" y2="18"></line>
    ...
    let n = null, t = null, e = null, d = !1, r = null, a = o.DEFAULT_POSITION;
    function getScript() {
    ...
    r = embedScript.getAttribute('data-organization-id');
    ...
    a =
      (embedScript.getAttribute('data-position')) ||
      o.DEFAULT_POSITION;
    ...
    if (!r) {
      ...
      document.readyState === "loading" ? document.addEventListener("DOMContentLoaded", g)
        : g()
    } function g() {
