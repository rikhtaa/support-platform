...
export const ConversationIdView = ({
  ...
  const [isEnhanching, setIsEnhanching] = useState(false)
  const enhanceResponse = useAction(api.private.messages.enhanceResponse)
  const handleEnhanceResponse = async () => {
     setIsEnhanching(true)
          ...
          <AIInput onSubmit={form.handleSubmit(onSubmit)}>
            ...
            <AIInputToolbar>
              <AIInputTools>
                ...
                >
                  <Wand2Icon />
                  {isEnhanching ? "Enhancing..." : "Enhance"}
                </AIInputButton>
              </AIInputTools>
              <AIInputSubmit
                disabled={
            ...
            {Array.from({ length: 8 }, (_, index)=> {
                ...
                return (
                    <div 
                      ...
                      key={index}
                    >
                        <Skeleton className={`h-9 ${width} rounded-lg bg-neutral-2001`}/>
